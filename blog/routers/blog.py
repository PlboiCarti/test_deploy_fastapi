...
from blog import schemas, database, oauth2 # .. --> thư mục cha
...
# Thêm current_user:schemas.User = Depends(oauth2.get_current_user) làm tham số
# --> Hàm đó muốn truy cập phải authorized trước
